...
_G.packer_plugins = {
  ...
  ["asyncrun.vim"] = {
    loaded = true,
    path = "/home/nure/.local/share/nvim/site/pack/packer/start/asyncrun.vim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'switch.vim', 'vimcdoc', 'nvim-scrollbar', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'switch.vim', 'vimcdoc', 'nvim-scrollbar', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
