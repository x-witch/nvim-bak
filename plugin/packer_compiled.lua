...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vimcdoc', 'undotree', 'switch.vim', 'nvim-scrollbar'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vimcdoc', 'undotree', 'switch.vim', 'nvim-scrollbar'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
