...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-scrollbar', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-scrollbar', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
