...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'AutoSave.nvim', 'switch.vim', 'toggleterm.nvim', 'nvim-scrollbar', 'vimcdoc'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'AutoSave.nvim', 'switch.vim', 'toggleterm.nvim', 'nvim-scrollbar', 'vimcdoc'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
