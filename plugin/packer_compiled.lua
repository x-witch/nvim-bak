...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'AutoSave.nvim', 'nvim-scrollbar', 'toggleterm.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'AutoSave.nvim', 'nvim-scrollbar', 'toggleterm.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
