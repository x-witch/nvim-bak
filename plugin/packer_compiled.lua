...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'toggleterm.nvim', 'switch.vim', 'vimcdoc', 'nvim-scrollbar', 'AutoSave.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'toggleterm.nvim', 'switch.vim', 'vimcdoc', 'nvim-scrollbar', 'AutoSave.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
