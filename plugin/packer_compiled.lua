...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'toggleterm.nvim', 'vimcdoc', 'nvim-scrollbar', 'AutoSave.nvim', 'switch.vim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'toggleterm.nvim', 'vimcdoc', 'nvim-scrollbar', 'AutoSave.nvim', 'switch.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
