...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'switch.vim', 'vimcdoc', 'nvim-scrollbar'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'faster.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'switch.vim', 'vimcdoc', 'nvim-scrollbar'}, { event = "BufRead *" }, _G.packer_plugins)]]
