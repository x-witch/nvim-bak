...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'switch.vim', 'AutoSave.nvim', 'nvim-scrollbar', 'vimcdoc', 'toggleterm.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'switch.vim', 'AutoSave.nvim', 'nvim-scrollbar', 'vimcdoc', 'toggleterm.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
