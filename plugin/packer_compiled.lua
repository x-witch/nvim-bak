...
_G.packer_plugins = {
  ...
  catppuccin = {
    ...
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["nvim-markdown-preview"] = {
    config = { "\27LJ\2\n:\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\31conf.nvim-markdown-preview\frequire\0" },
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/nvim-markdown-preview",
  ...
  ["vim-translator"] = {
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24conf.vim-translator\frequire\0" },
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/vim-translator",
  ...
  vimcdoc = {
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/vimcdoc",
...
try_loadstring("\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24conf.vim-translator\frequire\0", "config", "vim-translator")
time([[Config for vim-translator]], false)
-- Config for: nvim-markdown-preview
time([[Config for nvim-markdown-preview]], true)
try_loadstring("\27LJ\2\n:\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\31conf.nvim-markdown-preview\frequire\0", "config", "nvim-markdown-preview")
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-scrollbar', 'AutoSave.nvim', 'toggleterm.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-scrollbar', 'AutoSave.nvim', 'toggleterm.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
