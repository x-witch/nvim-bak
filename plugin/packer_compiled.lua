...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-scrollbar', 'vimcdoc', 'undotree', 'switch.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-scrollbar', 'vimcdoc', 'undotree', 'switch.vim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
