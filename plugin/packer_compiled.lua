...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vimcdoc', 'nvim-scrollbar', 'switch.vim', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vimcdoc', 'nvim-scrollbar', 'switch.vim', 'toggleterm.nvim', 'AutoSave.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
