...
_G.packer_plugins = {
  ...
  ["lualine.nvim"] = {
    ...
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["tokyonight.nvim"] = {
    ...
    loaded = true,
    path = "/home/nrnn/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'AutoSave.nvim', 'nvim-scrollbar', 'vimcdoc', 'toggleterm.nvim', 'switch.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'AutoSave.nvim', 'nvim-scrollbar', 'vimcdoc', 'toggleterm.nvim', 'switch.vim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
